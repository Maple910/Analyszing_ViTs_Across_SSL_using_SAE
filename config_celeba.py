...
# --- 分析ターゲット設定 ---
TARGET_ATTRIBUTE = "Smiling" # 分析したい属性名を設定 (例: "Smiling", "Male")

# --- SAE重みのパス ---
SAE_WEIGHTS_DIR = "./data/sae_weights_celeba/sae_weights_celeba_run_12" 
SAE_WEIGHTS_PATH_TEMPLATE = os.path.join(SAE_WEIGHTS_DIR, "sae_layer_{layer_idx}.pth")

# --- 結果の保存先 ---
ANALYSIS_SAVE_DIR = f"./data/analysis_celeba/analysis_results_{TARGET_ATTRIBUTE}/sae_weights_celeba_run_12"
