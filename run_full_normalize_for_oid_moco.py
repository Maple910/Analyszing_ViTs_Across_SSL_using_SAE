# 指定した特徴群（TRAGET_ATTRIBUTES）に対して可視化を行う（MoCo用）
...
SCRIPT_COMPARE = "compare_attribute_normalization_oid_moco.py"
...
def main():
    ...
    for attr in TARGET_ATTRIBUTES:
        ...
        # 3. 結果読み込み & ヒートマップ生成
        # 保存先パスの推定
        base_dir = cfg_moco.NORMALIZE_ANALYSIS_DIR.replace(f"_{cfg_moco.TARGET_ATTRIBUTE}", f"_{attr}")
